...
export const initial2ColResizeLayout: {[key: string]: Layout[]} = {
    lg: [
        { i: 'a', x: 0, y: 0, w: 6, minW: 3, maxW: 8, h: 2, isDraggable: false, isResizable: true, isBounded: true },
        { i: 'b', x: 7, y: 0, w: 6, minW: 3, maxW: 8, h: 2, isDraggable: false, isResizable: false, isBounded: true },
    ],
    md: [
        { i: 'a', x: 0, y: 0, w: 6, minW: 3, maxW: 8, h: 2, isDraggable: false, isResizable: true, isBounded: true },
        { i: 'b', x: 7, y: 0, w: 6, minW: 3, maxW: 8, h: 2, isDraggable: false, isResizable: false, isBounded: true },
