...
export const canvasViewerLayout: { [key: string]: Layout[] } = {
  ...
  sm: [
    { i: 'a', x: 0, y: 0, w: 12, h: 2, minH: 2, isDraggable: false, isResizable: false },
    { i: 'b', x: 0, y: 2, w: 12, h: 14, minH: 8, isDraggable: false, isResizable: true },
    { i: 'c', x: 0, y: 16, w: 12, h: 8, minH: 4, isDraggable: false, isResizable: true },
  ],
  xs: [
    { i: 'a', x: 0, y: 0, w: 12, h: 2, minH: 2, isDraggable: false, isResizable: false },
    { i: 'b', x: 0, y: 2, w: 12, h: 14, minH: 8, isDraggable: false, isResizable: true },
    { i: 'c', x: 0, y: 16, w: 12, h: 6, minH: 4, isDraggable: false, isResizable: true },
  ],
  xxs: [
    { i: 'a', x: 0, y: 0, w: 12, h: 2, minH: 2, isDraggable: false, isResizable: false },
